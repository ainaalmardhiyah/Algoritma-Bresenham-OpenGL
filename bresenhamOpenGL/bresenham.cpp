...
void display(void)
{
	...
	bresenham(200, 400, 400, 100); //jalankan fungsi bresenham

	bresenham(500, 500, 600, 500); //jalankan fungsi bresenham
	bresenham(100, 100, 20, 100); //jalankan fungsi bresenham
	bresenham(200, 100, 300, 100); //jalankan fungsi bresenham
	bresenham(400, 100, 500, 100); //jalankan fungsi bresenham
	bresenham(600, 100, 700, 100); //jalankan fungsi bresenham

	bresenham(100, 200, 100, 500); //jalankan fungsi bresenham
	bresenham(600, 200, 600, 500); //jalankan fungsi bresenham
